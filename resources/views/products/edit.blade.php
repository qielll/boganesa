                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('name', $product->item_name) }}"
                                            >
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                   ...
                                                   min="0"
                                                   value="{{ old('quantity', $product->item_quantity) }}"
                                                   placeholder="0"
                                            >
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                   ...
                                                   min="0"
                                                   placeholder="0"
                                                   value="{{ old('quantity_alert', $product->reorder_level) }}"
                                            >
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ $product->exp_date?->format('d-m-Y') ?? '-' }}"
                                                   placeholder=""
                                            >
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            {{-- <input type="text"
                                                   ...
                                                   placeholder=""
                                                   value="{{ $product->location?->location_name ?? '-' }}"
                                            > --}}

                                            <select name="location_name" id="location_name"
                                                    class="form-select @error('location_name') is-invalid @enderror"
                                            >
                                                <option selected="" disabled="">
                                                    Select a location:
                                                </option>
                                                ...
                                                @foreach ($locations as $location)
                                                    <option value="{{ $location->location_id }}" @if(old('location_id', $product->location_id) == $location->location_id) selected="selected" @endif>{{ $location->location_name }}</option>
                                                @endforeach
                                            </select>
